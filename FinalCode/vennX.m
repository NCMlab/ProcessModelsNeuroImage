function [error img] = vennX( data, resolution )
%
...
function [error img] = plot_venn3( a, b, c, d, e, f, g, resolution, dist_A_B, dist_B_C, dist_A_C )
    ...
    img = img + 7 .* ( (X - center1_x).^2 + (Y - center1_y).^2 < r1^2 );
    ...
    h = text( text_x, text_y, sprintf('%0.3f',a) );
...
%    h = text( text_x, text_y, num2str( b ) );
    h = text( text_x, text_y, sprintf('%0.3f',b) );
...
%    h = text( text_x, text_y, num2str( c ) );
    h = text( text_x, text_y, sprintf('%0.3f',c) );
...
%    h = text( text_x, text_y, num2str( d ) );
    h = text( text_x, text_y, sprintf('%0.3f',d) );
...
%    h = text( text_x, text_y, num2str( e ) );
    h = text( text_x, text_y, sprintf('%0.3f',e) );
...
%    h = text( text_x, text_y, num2str( f ) );
    h = text( text_x, text_y, sprintf('%0.3f',f) );
...
%    h = text( text_x, text_y, num2str( g ) );
    h = text( text_x, text_y, sprintf('%0.3f',g) );
    
    set( h, 'FontWeight', 'bold' )
    
function  [error img] = plot_venn2( a, b, c, resolution, dist )
