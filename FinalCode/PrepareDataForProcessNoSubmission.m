function OutFolder = PrepareDataForProcessNoSubmission(ModelInfo)
        ...
        case 'bootstrap'
            ...
            for i = 1:ModelInfo.NJobSplit
                ...
                if ~isempty(VoxelsForThisJob)
                    ...
                    [JobName,ClusterCommand] = SubmitClusterJobNoSub(jobPath,JobOutputFolder);
                    fprintf(1,'%s\n',ClusterCommand);
            ...
            SubmitClusterJobNoSub(jobPath,JobOutputFolder,WaitList);
