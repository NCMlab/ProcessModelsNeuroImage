...
================================
-RunCompiledBootStrap 
-run_RunCompiledBootStrap.sh (shell script for temporarily setting environment variables 
   ...
   -to run the shell script, type
    ...
    run the shell script as:
       ...
       ./run_RunCompiledBootStrap.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_RunCompiledBootStrap.sh 
